/*
	...
	Write a program to read Vacation Period (Date From and Date To) and make a function to 
...
int main()
{
	...
	sDate VacationStart, VacationEnd;

	cout << "Vacation Start:\n";
	VacationStart = ReadDate();

	cout << "\nVacation End:\n";
	VacationEnd = ReadDate();

	cout << "\n\nVacation From: " << DayName(DayOrderInTheWeek(VacationStart)) << ", " << 
		 VacationStart.Day <<"/" << VacationStart.Month << "/" << VacationStart.Year << endl;

	cout << "Vacation to: " << DayName(DayOrderInTheWeek(VacationEnd)) << ", " <<
		VacationEnd.Day << "/" << VacationEnd.Month << "/" << VacationEnd.Year << endl;


	cout << "\n\nactucal Vacation days is: " << CalculateVacationDays(VacationStart, VacationEnd) << endl;
