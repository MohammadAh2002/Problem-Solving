...
int add_the_even_nums_ForLoop(int num) {
...
int add_the_even_nums_WhileLoop(int num) {
...
int add_the_even_nums_DoWhileLoop(int num) {
...
int main()
{
	...
	read_number(num);
	print_sum_oddV(add_the_even_nums_ForLoop(num));
	print_sum_oddV(add_the_even_nums_WhileLoop(num));
	print_sum_oddV(add_the_even_nums_DoWhileLoop(num));
}
